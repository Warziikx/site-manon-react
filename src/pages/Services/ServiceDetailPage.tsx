...
import { MotionMansonery } from "@/components/Widget/Mansonery/MotionMansonery";
		...
		<div className="mt-0 md:mt-16">
			...
			{prestation.pricing && (
				<div className="space-y-16 py-16 lg:px-32">
					<h3 className="text-center font-title text-4xl font-semibold text-ternary">
						{prestation.pricing.title}
					</h3>
					{prestation.pricing.list && prestation.pricing.list.length !== 0 ? (
						<div className={`md:grid-cols-${prestation.pricing.list.length} grid grid-cols-1 gap-16`}>
							{prestation.pricing.list.map((pricingData: IPricingObj) => (
								<div className="flex flex-col items-center justify-center">
									<h4 className="whitespace-pre-line px-16 text-center text-xl text-ternary">
										{pricingData.title}
									</h4>
									<ul className="mt-4">
						...
						<div className="mx-auto space-y-4 text-center">
							...
							<p>
								Chaque projet étant unique et spécifique à vos besoins, mes tarifs sont déterminés sur mesure.
								Je m'engage à fournir des services personnalisés pour répondre parfaitement à vos attentes.
								Pour obtenir un devis adapté à votre projet et discuter des tarifs, veuillez me contacter. Je
								serais ravi(e) d'échanger avec vous et de vous fournir toutes les informations nécessaires
