  ...
  return (
    <>
      <div className="relative h-spe-height overflow-hidden bg-link-water">
        ...
        <img src={fleur3} className="absolute -left-12 bottom-4 w-96 rotate-6 md:left-0 xl:left-32" />
        ...
        <img src={fleur1} className="absolute -right-36 top-32 hidden w-4/12 rotate-180 md:block lg:-right-24" />
      </div>
