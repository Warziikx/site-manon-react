...
import { ServiceDetailPage, ServiceGroupePage } from "@/pages/Services";
// Create a root route
...
const routeTree = rootRoute.addChildren([indexRoute, serviceGroupeRoute, serviceDetailRoute, contactRoute]);
