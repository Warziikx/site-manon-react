    ...
    <div className="grid min-h-spe-height grid-cols-12 gap-8 overflow-x-hidden py-16 lg:px-32">
      <div className=" col-span-12 mx-8 my-auto md:col-span-8 md:mx-16">
        ...
        <div className="space-y-8">
          ...
          <p>
            Mais au-delà des compétences, c'est la passion qui m'anime. La photographie n'est pas seulement mon métier,
            c'est ma passion. Chaque instant capturé est un fragment de vie, figé dans le temps. Chaque création
            graphique est une fusion d'art et de communication.
          </p>
          <p>
