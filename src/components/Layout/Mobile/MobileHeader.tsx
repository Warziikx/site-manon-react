  ...
  return (
    ...
    >
      <span className="block px-8 text-center text-sm text-gray-300 sm:text-center">
        © {currentYear}{" "}
        <Link resetScroll={true} to="/" className="hover:underline" onClick={closeMenu}>
          Manon Bertho Studio
        </Link>
      ...
      <Link resetScroll={true} to="/" className="mb-4 flex items-center sm:mb-0" onClick={closeMenu}>
